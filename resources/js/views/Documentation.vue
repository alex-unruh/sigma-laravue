    ...
    <div class="p-col-12">
      <div class="card docs">
        ...
        <p>
          ...
          out-of-the-box standard tooling for Vue projects. To get started,
          clone the
          <a href="https://github.com/primefaces/sigma-vue">repository</a> from
...
yarn
        ...
        <p>
          ...
          navigate to <b>http://localhost:8080/</b> to view the application.
          That is it, you may now start with the development of your application
          using the Sigma template.
        </p>
...
"npm run test:unit": Runs the tests.
        ...
        <p>
          ...
          a couple of child components such as topbar, profile, menu and footer.
          Here is template of the <i>App.vue</i> component that implements the
          logic such as menu state, layout modes and so on.
        </p>
...
&lt;/template&gt;
        ...
        <p>
          ...
          on PrimeNG MenuModel API. In order to define the menuitems, navigate
          to data section of <i>App.vue</i> file and define your own model as a
          nested structure using the menu property. Here is the menu component
          from the demo application. Notice that menu object is bound to the
          model property of AppMenu component as shown above.
        </p>
...
data() {
    return {
        ...
        <p>
          ...
          package.json. Sigma has no direct dependency, even PrimeVue components
...
<code>
{
    ...
    "primeflex": "2.0.0",             //optional: Grid system
        ...
        <p>To setup Sigma in an existing project, follow the steps below;</p>

        <ul>
          <li>
            Copy the <i>public/assets</i> folder to your projects folder with
            the same name
          </li>
          <li>
            Copy all <i>src/App*.vue</i> files to the src folder of your
            application.
          </li>
        </ul>
...
npm install primeflex@latest --save
        ...
        <h4>Saga Theme</h4>
        <p>
          Sigma uses the free Saga-Blue which is a free theme distributed within
          PrimeVue, however it can be used with any PrimeVue theme as well.
        </p>
...
$footerBgColor:#ffffff;
        ...
        <h4>Menu Modes</h4>
        <p>
          Menu has 2 modes, <i>static</i> and <i>overlay</i>. Main layout
          container element in App.vue is used to define which mode to use by
          adding specific classes. List below indicates the style classes for
          each mode.
        </p>
        ...
        <p>
          For example to create an overlay menu, the div element should be in
          following form;
        </p>
        <pre v-code>
<code><template v-pre>
&lt;div class="layout-wrapper layout-static"&gt;
        ...
        <p>
          ...
          preference at a component and using an expression to bind it so that
          user can switch between modes. Sample application has an example
          implementation of such use case with a computed property. Refer to
          App.vue for an example.
        </p>
        ...
        <p>
          ...
          <i>layout-sidebar-light</i> or <i>layout-sidebar-dark</i> to the
          sidebar element.
        </p>
...
&lt;div class="layout-sidebar layout-sidebar-light"&gt;
        ...
        <p>
          ...
          grid library can be used, we recommend using PrimeFlex as your layout
          framework as it is well tested and supported by PrimeVue. PrimeFlex is
          available at
        ...
        <p>
          ...
          <i>_overrides.scss</i> file instead of adding them to the scss files
          under sass folder to avoid maintenance issues after an update.
        </p>
      </div>
    </div>
  </div>
